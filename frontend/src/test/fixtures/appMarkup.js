        ...
        <div class="chat-content">
          <div class="scroll-wrapper">
            <div class="empty-state">
              <div class="sakura-frame" aria-hidden="true"><svg class="sakura-torii" viewBox="0 0 240 190"><path d="M0 0"/></svg><svg class="sakura-limb sakura-limb-tl" viewBox="0 0 180 122"><path d="M0 0"/></svg><svg class="sakura-limb sakura-limb-br" viewBox="0 0 180 122"><path d="M0 0"/></svg></div>
...
<div class="signin-root">
  ...
  <div class="sakura-frame">
    ...
    <svg class="sakura-limb sakura-limb-tl" viewBox="0 0 180 122"><path d="M0 0"/></svg>
  </div>
