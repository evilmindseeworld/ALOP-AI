   ...
   <div class="app-frame">
    ...
    <div class="plan-grid">
        ...
        <div class="chat-content">
          <div class="sakura-base" aria-hidden="true"><svg class="sakura-keystone" viewBox="0 0 48 24"><path d="M0 0"/></svg></div>
          ...
          <div class="input-bar">
            <div class="input-wrapper"><div class="composer-sprigs" aria-hidden="true"><div class="composer-skyline"><svg viewBox="0 0 1040 38"><g class="composer-weather"><circle class="composer-sun" cx="96" cy="11" r="9"/><g class="composer-clouds"><rect x="18" y="4.2" width="24" height="3.4" rx="1.7"/></g></g><g class="composer-town" transform="translate(0 16)"><path d="M0 22"/></g></svg></div><svg class="sakura-seal composer-seal" viewBox="0 0 32 32"><rect width="32" height="32"/></svg></div>
    ...
    <ul class="file-chips">
                <li class="file-chip"><svg width="12" height="12" viewBox="0 0 24 24"><path d="M0 0"/></svg><span class="file-chip-name">budget.csv</span><button class="file-chip-keep" aria-pressed="false" aria-label="Keep budget.csv in every chat"><svg width="12" height="12" viewBox="0 0 24 24"><path d="M0 0"/></svg></button><button class="file-chip-download" aria-label="Download budget.csv"><svg width="12" height="12" viewBox="0 0 24 24"><path d="M0 0"/></svg></button><button aria-label="Remove budget.csv">×</button></li>
                <li class="file-chip file-chip-kept"><svg width="12" height="12" viewBox="0 0 24 24"><path d="M0 0"/></svg><span class="file-chip-name">a-very-long-attachment-filename-that-must-truncate.md</span><button class="file-chip-keep" aria-pressed="true" aria-label="It is kept in every chat. Attach to this chat only"><svg width="12" height="12" viewBox="0 0 24 24"><path d="M0 0"/></svg></button><button aria-label="Remove it">×</button></li>
              </ul>
