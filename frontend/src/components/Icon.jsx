 ...
 *
 * Inline rather than an icon package because the whole set is under 3kB and a
 * dependency would ship several hundred glyphs to deliver twenty. Each is a
 * plain SVG using `currentColor`, so an icon inherits the colour of whatever
 * button it sits in and needs no per-state styling.
 *
 * An unknown name renders nothing rather than throwing — a missing icon should
 * not take a toolbar down.
 */
const ICONS = {
  ...
  pin: <path d="M12 2l-5.5 9h11L12 2zm0 3.84L13.93 9h-3.87L12 5.84zM17.5 13c-2.49 0-4.5 2.01-4.5 4.5s2.01 4.5 4.5 4.5 4.5-2.01 4.5-4.5-2.01-4.5-4.5-4.5zm0 7a2.5 2.5 0 1 1 0-5 2.5 2.5 0 0 1 0 5zM5 19.5h6v-2H5v2z" />,
  ...
  // Output, not input: `mic` is the composer's dictation button and using it
  // for "read this to me" would give the two opposite directions the same sign.
  speaker: (
    <>
...
const FILLED = new Set(["crown", "stop"]);
